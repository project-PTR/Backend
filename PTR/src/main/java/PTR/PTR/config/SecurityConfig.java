        ...
        return http
                .authorizeRequests(auth -> auth
                        .requestMatchers(
                                ...
                                new AntPathRequestMatcher("/feed/**"),
                                new AntPathRequestMatcher("/feedLike/**"),
                                ...
                                new AntPathRequestMatcher("/calendarDietPlan/**"),
                                new AntPathRequestMatcher("/calendarDietRecord/**"),
                                new AntPathRequestMatcher("/calendarExercisePlan/**"),
                                new AntPathRequestMatcher("/calendarExerciseRecord/**")
                        ).permitAll()
